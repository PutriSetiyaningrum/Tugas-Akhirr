              ...
              <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td width="10%">
                        <a href="{{ url('/dashboard/hasilpertandingan/' . $item->id . '/edit') }}"><i class="fas fa-edit"></i></a>
                        |
                        <form action="{{ url('/dashboard/hasilpertandingan/'.$item->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method("DELETE")
                            <button type="submit">
